...
(custom-set-variables
 ...
 '(package-selected-packages
   '(helm-bibtex bibtex-completion org-roam-bibtex company-quickhelp ox-hugo yasnippet window-numbering which-key use-package solarized-theme rainbow-delimiters org-roam org-plus-contrib org-pdftools ob-julia-vterm lsp-mode jupyter julia-mode doom-themes doom-modeline counsel company)))
(custom-set-faces
